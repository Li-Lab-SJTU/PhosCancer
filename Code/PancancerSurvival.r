setwd('/dssg/home/acct-clslj/clslj-2/Dongqun/Projects/PhosCancer/Analysis/Quantitative/Surdiffer/')
...
jpeg(filename=paste0('/dssg/home/acct-clslj/clslj-2/Dongqun/Projects/PhosCancer/Analysis/PNGs/Surdiffer/',Annotation[Annotation[,1]==whichsite,4],'_',Annotation[Annotation[,1]==whichsite,3],'_ALL.jpeg'),width = 1000, height = pngheight)
...
#specify position here
  ...
  ylab('Hazard ratios with 95% CI') + xlab("")+#Hazard ratios with 95% CI  HR(95%CI)
#specify position here too
  ...
  theme_minimal()+
  theme(strip.text.x = element_text(size = 14,face = "bold", colour = "black")) + # 设置分面的字字体大小、颜色、背景、边框，
