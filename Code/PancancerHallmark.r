...
Hallmark.rename <- read.table('/dssg/home/acct-clslj/clslj-2/Dongqun/Projects/PhosCancer/Analysis/Hallmark.rename.tsv',sep='\t',header = TRUE,fill=T,check.names=F,stringsAsFactors = FALSE, encoding = "latin1")
...
#temp<-data.frame(Hallmark=names(corP),SpearmanP=corP,SpearmanFDR=p.adjust(corP,'BH'),SpearmanE=corE)
...
#png(filename=paste0('/dssg/home/acct-clslj/clslj-2/Dongqun/Projects/PhosCancer/Analysis/PNGs/',Annotation[Annotation[,1]==whichsite,4],'_',Annotation[Annotation[,1]==whichsite,3],'_ALL.png'),width = 1160, height = nrow(Total)*8)
jpeg(filename=paste0('/dssg/home/acct-clslj/clslj-2/Dongqun/Projects/PhosCancer/Analysis/PNGs/HallmarkCor/',Annotation[Annotation[,1]==whichsite,4],'_',Annotation[Annotation[,1]==whichsite,3],'_ALL.jpeg'),width = 1160, height = nrow(Total)*8)
