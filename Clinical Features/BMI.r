...
write.table(Agediffer,file=paste0("/dssg/home/Projects/PhosCancer/Analysis/Quantitative/BMICor/",Cancertype,"_BMICor.tsv"),sep="\t",quote=F,row.names=T,col.names=T)
